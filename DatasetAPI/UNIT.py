...
class UNIT(object):
    ...
    def build_model(self):
        ...
        trainB = trainB.map(Image_Data_Class.image_processing, num_parallel_calls=8).shuffle(10000).prefetch(self.batch_size).batch(self.batch_size).repeat()
        ...
        """ Generated Image """
        self.fake_B, _ = self.generate_a2b(self.test_domain_A) # for test
        self.fake_A, _ = self.generate_b2a(self.test_domain_A) # for test
    ...
    def test(self):
        ...
        for sample_file  in test_A_files : # A -> B
            ...
            fake_img = self.sess.run(self.fake_B, feed_dict = {self.test_domain_A : sample_image, self.is_training : False})
        ...
        for sample_file  in test_B_files : # B -> A
            ...
            fake_img = self.sess.run(self.fake_A, feed_dict = {self.test_domain_B : sample_image, self.is_training : False})
